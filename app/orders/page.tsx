...
export default function OrdersPage() {
  ...
  const promptDelete = (orderId: string) => {
    setConfirmAction({
      title: 'Cancel Order',
      message: 'Cancel/Delete this order? This cannot be undone.',
      onConfirm: async () => {
        try {
          setLoading(true)
      ...
      <div className="max-w-[1580px] mx-auto px-4 sm:px-6 py-8 w-full flex flex-col md:flex-row gap-6 md:gap-8 flex-1">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 m-0">My Orders</h1>
              <p className="text-gray-500 mt-2 text-[0.95rem]">Manage your client orders</p>
            </div>
            <Link
              href="/orders/new"
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-xl p-12 text-center shadow-[0_1px_4px_rgba(0,0,0,0.06)] border border-gray-50 flex flex-col items-center justify-center">
              ...
              <p className="text-gray-500 mb-6 text-sm">Start by creating your first order for this tab</p>
              <Link
                href="/orders/new"
